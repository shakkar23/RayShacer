...
World::blockInfo World::voxel_traversal_old(const vec3 ray_start, const vec3 ray_direction) const {
	//auto voxelSize = 1;
...
World::blockInfo World::voxel_traversal_new(const vec3 SourcePos, const vec3 Dir) const {
